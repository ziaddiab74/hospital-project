...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins">
  ...
  <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
	    		...
	    		<div class="col-lg-10 d-none d-md-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">Email: ziaddiab74@gmail.com</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image: url('images/image_5.jpg');" data-section="home" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
          		<span class="subheading">Welcome to Cairo hospital</span>
      ...
      <div class="ftco-services ftco-no-pb">
			<div class="container">
          ...
          <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
            <div class="media block-6 d-block text-center color-black">
              <div class="icon d-flex justify-content-center align-items-center">
            		<span class="flaticon-ambulance"></span>
              </div>
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Emergency Care</h3>
                <p>Emergency number : 19991</p>
