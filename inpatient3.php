	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
          ...
          <li class="nav-item "><a href="index.php" class="nav-link pl-0">Home</a></li>
            ...
            <li class="nav-item active"><a href="inpatient.php" class="nav-link">Inpatient clinics</a></li>
...
<p> Lecturer of surgery MedicineSuez Canal univ</p>
  ...
  <button type="button" class="btn btn-success btn-lg btn-block" style="background-color:black" data-toggle="modal" data-target="#myModal">
    Book
  </button>
